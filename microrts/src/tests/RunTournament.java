...
public class RunTournament {
    public static void main(String args[]) throws Exception {
        ...
        int maxGameLength = 10000;                      // Maximum game length (default 2000 ticks)
        ...
        AIs.add(new RangedRush(utt, new BFSPathFinding()));
        AIs.add(new LightRush(utt, new BFSPathFinding()));
        AIs.add(new WorkerRushPlusPlus(utt, new BFSPathFinding()));
        AIs.add(new GroupG_AI_1(utt, new BFSPathFinding()));
        AIs.add(new EconomyMilitaryRush(utt, new BFSPathFinding()));
        AIs.add(new EconomyRushBurster(utt, new BFSPathFinding()));
